  ...
  return (
    ...
    >
      ...
      <div className="absolute top-0 left-1/2 -translate-x-1/2 w-full h-full -z-10">
        <div className="absolute top-[-10%] left-1/2 -translate-x-1/2 w-[1000px] h-[600px] bg-primary/20 blur-[120px] rounded-full opacity-50" />
      ...
      <div className="max-w-5xl mx-auto text-center space-y-8 relative z-10">
        <div 
          data-animate
          className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full border bg-card/50 backdrop-blur-sm text-xs font-bold text-primary mb-4"
        >
        ...
        <div className="pt-16 grid grid-cols-2 md:grid-cols-4 gap-8 opacity-40 grayscale hover:grayscale-0 transition-all duration-500">
