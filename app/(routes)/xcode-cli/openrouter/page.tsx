...
export default function XCodeCliOpenRouterPage() {
  ...
  const handleConnect = async () => {
    ...
    try {
      // PKCE + state are stored only in sessionStorage for this connection attempt.
    ...
    <div className="min-h-screen w-full bg-background">
      <div className="sticky top-0 z-30 border-b border-border/60 bg-background/90 backdrop-blur">
        <div className="mx-auto flex max-w-6xl items-center justify-between px-6 py-3">
          ...
          >
            <Link href="/xcode-cli" className="flex items-center gap-2">
        ...
        <div className="mx-auto max-w-6xl space-y-8 px-6">
          <div className="space-y-4">
            ...
            <h1 className="text-3xl sm:text-4xl font-semibold tracking-tight">
              Connect OpenRouter to X-code CLI
            </h1>
            <p className="text-base text-muted-foreground">
              Use OpenRouter to access multiple models while keeping your CLI
              session consistent. This page explains how we handle keys and
              launches the OAuth flow when you are ready.
            </p>
          </div>
          ...
          <div className="grid gap-6 lg:grid-cols-[1.05fr_0.95fr]">
            <div className="space-y-6">
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="mt-2 text-sm text-muted-foreground">
                      We do not store your OpenRouter API keys in our database.
                      The connection uses OAuth and scoped tokens for safe
                      access.
                    </p>
                  </div>
                </div>
                <div className="mt-6 grid gap-4 sm:grid-cols-2">
                  {[
                    ...
                    },
                    {
                      ...
                      description:
                        "Only the required routing scopes are requested.",
                    },
                    {
                      title: "Safe by default",
                      description:
                        "Sensitive data is redacted in CLI telemetry.",
                    },
                    {
              ...
              <div className="rounded-3xl border bg-muted/20 p-6">
                ...
                <p className="mt-2 text-sm text-muted-foreground">
                  Start the OpenRouter OAuth flow to authorize X-code CLI.
                </p>
                      ...
                      <DialogContent className="rounded-3xl">
                        <DialogHeader>
                          ...
                          <DialogDescription>
                            ...
                            stored keys from this browser session. You can
                            reconnect anytime.
                          </DialogDescription>
                        </DialogHeader>
                        <DialogFooter>
